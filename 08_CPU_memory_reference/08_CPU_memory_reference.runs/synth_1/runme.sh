...
HD_PWD='D:/vivado/08_CPU_memory_reference/08_CPU_memory_reference.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log board_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source board_cpu.tcl
