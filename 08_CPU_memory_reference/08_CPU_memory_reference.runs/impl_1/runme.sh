...
HD_PWD='D:/vivado/08_CPU_memory_reference/08_CPU_memory_reference.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log board_cpu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source board_cpu.tcl -notrace
