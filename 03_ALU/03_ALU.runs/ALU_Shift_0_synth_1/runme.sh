...
HD_PWD='D:/vivado/03_ALU/03_ALU.runs/ALU_Shift_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Shift_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_Shift_0.tcl
