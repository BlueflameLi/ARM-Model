...
#
# Generated by export_simulation on Mon Apr 19 01:05:33 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './ALU_Shift_0.sh' script.

./ALU_Shift_0.sh -reset_run
...
./ALU_Shift_0.sh -noclean_files

For more information on the script, please type './ALU_Shift_0.sh -help'.
