...
HD_PWD='D:/vivado/04_RegFile/04_RegFile.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Regfile_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Regfile_Board.tcl -notrace
