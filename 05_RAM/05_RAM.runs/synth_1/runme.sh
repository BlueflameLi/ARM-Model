...
HD_PWD='D:/vivado/05_RAM/05_RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_Board.tcl
