...
HD_PWD='D:/vivado/05_RAM/05_RAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RAM_Board.tcl -notrace
