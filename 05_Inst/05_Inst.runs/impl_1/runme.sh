...
HD_PWD='D:/vivado/05_Inst/05_Inst.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Inst_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Inst_Board.tcl -notrace
