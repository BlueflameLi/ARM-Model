...
HD_PWD='D:/vivado/05_Inst/05_Inst.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inst_Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inst_Board.tcl
