...
set_property used_in_implementation false [get_files D:/vivado/05_Inst/Board.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top Inst_Board -part xc7a100tfgg484-2L


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Inst_Board.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Inst_Board_utilization_synth.rpt -pb Inst_Board_utilization_synth.pb"
